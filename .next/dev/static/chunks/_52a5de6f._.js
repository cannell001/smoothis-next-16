...
"[project]/app/[id]/page.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function UpdatePage() {
        ...
        "UpdatePage.useEffect": ()=>{
            ...
            const fetchSmoothie = {
                "UpdatePage.useEffect.fetchSmoothie": async ()=>{
                    setLoading(true);
                    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].from('smoothies').select().eq('id', id).single();
                    if (error || !data) {
                        router.replace('/');
                        return;
                    }
    ...
    const handleSubmit = async (event)=>{
        ...
        setSaving(true);
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].from('smoothies').update({
            title,
            method,
            rating
        }).eq('id', id);
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                    type: "submit",
                    disabled: saving,
                    children: saving ? 'Saving...' : 'Update Smoothie Recipe'
                }, void 0, false, {
                    fileName: "[project]/app/[id]/page.jsx",
                    lineNumber: 102,
                    columnNumber: 17
...
_s(UpdatePage, "4l9ItZpuhtBHv3ww1mFgYRMj2xE=", false, function() {
    return [
...
//# sourceMappingURL=_52a5de6f._.js.map