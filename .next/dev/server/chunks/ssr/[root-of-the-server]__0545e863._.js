...
"[project]/app/[id]/page.jsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function UpdatePage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const fetchSmoothie = async ()=>{
            setLoading(true);
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].from('smoothies').select().eq('id', id).single();
            if (error || !data) {
                router.replace('/');
                return;
            }
    ...
    const handleSubmit = async (event)=>{
        ...
        setSaving(true);
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].from('smoothies').update({
            title,
            method,
            rating
        }).eq('id', id);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0545e863._.js.map